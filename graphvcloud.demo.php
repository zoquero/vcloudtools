...
function usage() {
    ...
    echo PHP_EOL;
    echo "  [Usage]" . PHP_EOL;
    echo "     # php graphvcloud.demo.php --output <file> (--title \"<title>\") (--part partType=partName)" . PHP_EOL;
    echo "     # php graphvcloud.demo.php -o <file> (-t \"<title>\") (-r partType=partName)"                . PHP_EOL;
    echo PHP_EOL;
