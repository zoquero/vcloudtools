...
function usage() {
    ...
    echo "\n";
    echo "     -s|--server <IP|hostname>        [opt] IP or hostname of the vCloud Director.\n";
    echo "     -u|--user <username>             [opt] User name in the form user@organization\n";
    echo "                                           for the vCloud Director.\n";
    echo "     -p|--pswd <password>             [opt] Password for user.\n";
    echo "     -v|--sdkver <sdkversion>         [opt] SDK Version e.g. 1.5, 5.1 and 5.5.\n";
    echo "     -f|--fromip                      [opt] source IP addres (defaults to 'any')\n";
    echo "     -g|--fromport                    [opt] source port (defaults to 'any')\n";
    echo "     -h|--proto                       [opt] source proto ('T' for TCP, 'U' for UDP, 'I' for ICMP, 'A' or '*' for any) (defaults to 'any')\n";
    echo "     -i|--toip                        [opt] destination IP addres (defaults to 'any')\n";
    echo "     -j|--toport                      [opt] destination Port (defaults to 'any')\n";
    echo "     -o|--org                         [opt] Organization\n";
    echo "     -d|--vdc                         [opt] Virtual Data Center name\n";
    echo "     -e|--vse                         [opt] vShield Edge Gateway name\n";
    echo "\n";
    echo "  You can set the security parameters like server, user and pswd in 'config.php' file, this is why they're optional parameters.\n";
    echo "\n";
    echo "  [Examples]\n";
